...
#         api_key=os.getenv("sk-087bcc0f8c3e4bf9a33ca98f634ab271"),
...
def create_deepseek_model_client():
    ...
    return OpenAIChatCompletionClient(
        ...
        # 非 OpenAI 官方模型必须显式提供 model_info，
        # 否则 autogen 无法根据模型名推断能力会直接报错
        model_info={
            "vision": False,              # DeepSeek 不支持图片输入
            "function_calling": True,      # 支持工具/函数调用
            "json_output": True,           # 支持 JSON 输出
            "family": "unknown",           # 非 OpenAI 模型族
